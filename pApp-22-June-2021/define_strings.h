...
#define STRING_MEASURING_IDLE                       tr("Return to Idle State")

#define STRING_MEASURING_MOVING_PISTON              tr("Moving Piston to ")
#define STRING_MEASURING_MOVING_PISTON_0_ML         tr("Moving Piston to 0 ml")
...
#define STRING_MEASURING_MOVING_PISTON_5_25_ML       tr("Moving Piston 5.25 ml")

#define STRING_MEASURING_MOVING_VALVE_EXHAUST       tr("Moving Valve to Outlet")
#define STRING_MEASURING_MOVING_VALVE_IN            tr("Moving Valve to Inlet")
